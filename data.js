...
books.push({author: 'Övriga', serie: 'Bonnie Garmus', book: 'Lektioner i kemi', year: , bought: 'FALSE'})
books.push({author: 'Övriga', serie: 'Dan Brown', book: 'Da Vinci koden serie', year: , bought: 'FALSE'})
books.push({author: 'Övriga', serie: 'Fredrik Backman', book: 'Björnstadserien', year: , bought: 'FALSE'})
books.push({author: 'Övriga', serie: 'Freida Mcfadden', book: 'Hembiträdet', year: , bought: 'FALSE'})
...
books.push({author: 'Övriga', serie: 'Niklas Natt och Dag', book: '1793', year: , bought: 'FALSE'})
books.push({author: 'Övriga', serie: 'Niklas Natt och Dag', book: '1794', year: , bought: 'FALSE'})
books.push({author: 'Övriga', serie: 'Terry Hayes', book: 'Jag är Pilgrimen', year: , bought: 'FALSE'})
books.push({author: 'Övriga', serie: 'Yuval Noah Harari', book: 'Sapiens: en kort historik över mänskligheten', year: , bought: 'FALSE'})
