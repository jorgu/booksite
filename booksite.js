...
books.push({author: 'Diverse', serie: 'Katarina Mazetti', book: 'Grabben i graven brevid', year: , bought: 'FALSE'});
books.push({author: 'Diverse', serie: 'Katarina Mazetti', book: 'Familjegraven', year: , bought: 'TRUE'});
books.push({author: 'Diverse', serie: 'Jonas Jonasson', book: 'Hundraåringen som klev ut ...', year: , bought: 'TRUE'});
}
