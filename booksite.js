...
function init(isAdmin) {
    ...
    books.push({author: 'Diverse', serie: 'Katarina Mazetti', book: 'Grabben i graven bredvid', year: 2002, bought: 'TRUE'});
    ...
    return isAdmin ? books : books.filter(book => book.bought === 'TRUE');
}
